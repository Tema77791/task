...
# 5. Проверял, что это имя скачанного файла совпадает с именем файла-установщика, указанного на сайте
  ...
  Функция: UI
    ...
    Сценарий: Работа с web-страницей
      ...
      Тогда Нажимаю на кнопку с текстом "Скачать Ruby"
      И Скачиваю первый файл из раздела "Стабильные релизы:"
      И Проверяю файл в нужной директории по имени файла установщика
